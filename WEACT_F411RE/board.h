...
#undef BOARD_VERSION_V6
#undef BOARD_VERSION_V7
#undef BOARD_VERSION_EE1
#undef BOARD_VERSION_EE2
#define BOARD_VERSION_EE3

#if !defined(BOARD_VERSION_V6) && !defined(BOARD_VERSION_V7) && !defined(BOARD_VERSION_EE1) && !defined(BOARD_VERSION_EE2) && !defined(BOARD_VERSION_EE3)
#error "Define el tipo de placa"
#endif
...
#ifdef BOARD_VERSION_V6
#define ACTIVAPAD palClearLine
#define QUITAPAD  palSetLine
#else
#define ACTIVAPAD palSetLine
#define QUITAPAD  palClearLine
#endif
...
#define NRF24L01_SPI_SCK             3U
#define NRF24L01_SPI_MISO            4U
#define NRF24L01_SPI_MOSI            5U
#define GPIOB_I2C1SCL                6U
#define GPIOB_I2C1SDA                7U
#define NRF24L01_SPI_CS             8U
#define NRF24L01_IRQ            9U
#define GPIOB_PIN10                 10U
#define GPIOB_PIN11                 11U
#define GPIOB_PIN12                 12U
#define GPIOB_PIN13                 13U
#define GPIOB_PIN14                 14U
#define NRF24L01_CE            15U
...
#define LINE_ONGPS                  PAL_LINE(GPIOB,13U)
#define LINE_ONAD                   PAL_LINE(GPIOB,15U)
#define LINE_A0_KEY                 PAL_LINE(GPIOA, 0U)


#ifdef BOARD_VERSION_EE3
#define LINE_SENSOR                 PAL_LINE(GPIOB, 8U)
#define LINE_ONSERVO                PAL_LINE(GPIOB, 4U)
#define LINE_PWMSERVO               PAL_LINE(GPIOB, 9U)
#define LINE_RXGPS                  PAL_LINE(GPIOA, 12U)
#define SD_GPS                      SD6
#define LINE_TXHM10SERIAL           PAL_LINE(GPIOB, 6U)
#define LINE_RXHM10SERIAL           PAL_LINE(GPIOB, 7U)
#define LINEONSERIALHM10            LINE_ONSIM800
#define ttyHM10                     &SD1
#define LINE_TXSERIAL               PAL_LINE(GPIOA, 2U)
#define LINE_RXSERIAL               PAL_LINE(GPIOA, 3U)
#define ttyPin                      &SD2
#endif
...
#define NRF24L01_LINE_IRQ           PAL_LINE(GPIOB,  9U)
#define NRF24L01_LINE_CE            PAL_LINE(GPIOB, 15U)
...
#define LINE_ONSIM800               PAL_LINE(GPIOB, 5U)
#define LINE_B6_TX1                 PAL_LINE(GPIOB, 6U)
#define LINE_B7_RX1                 PAL_LINE(GPIOB, 7U)
 ...
 * PB3  - NRF24L01_SPI_SCK             (alternate 05).
 * PB4  - NRF24L01_SPI_MISO            (alternate 05).
 * PB5  - NRF24L01_SPI_MOSI            (alternate 05).
 * PB6  - GPIOB_I2C1SCL                (alternate 04).
 * PB7  - GPIOB_I2C1SDA                (alternate 04).
 * PB8  - NRF24L01_SPI_CS              (output pushpull).
 * PB9  - NRF24L01_IRQ                 (input pullup).
 * PB10 - GPIOB_PIN10                  (input analog).
 * PB11 - GPIOB_PIN11                  (input analog).
 * PB12 - GPIOB_PIN12                  (input analog).
 * PB13 - GPIOB_PIN13                  (output pushpull).
 * PB14 - GPIOB_PIN14                  (output pushpull).
 * PB15 - NRF24L01_CE                  (output pushpull).
 */
#define VAL_GPIOB_MODER             (PIN_MODE_ANALOG(GPIOB_VBAT) |         \
                                     PIN_MODE_ANALOG(GPIOB_PIN1) |           \
                                     PIN_MODE_ANALOG(GPIOB_PIN2) |           \
                                     PIN_MODE_ALTERNATE(NRF24L01_SPI_SCK) |           \
                                     PIN_MODE_ALTERNATE(NRF24L01_SPI_MISO) |           \
                                     PIN_MODE_ALTERNATE(NRF24L01_SPI_MOSI) |           \
                                     PIN_MODE_ALTERNATE(GPIOB_I2C1SCL) |           \
                                     PIN_MODE_ALTERNATE(GPIOB_I2C1SDA) |           \
                                     PIN_MODE_OUTPUT(NRF24L01_SPI_CS) |           \
                                     PIN_MODE_INPUT(NRF24L01_IRQ) |           \
                                     ...
                                     PIN_MODE_OUTPUT(NRF24L01_CE))
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_VBAT) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN1) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN2) |     \
                                     PIN_OTYPE_PUSHPULL(NRF24L01_SPI_SCK) |     \
                                     PIN_OTYPE_PUSHPULL(NRF24L01_SPI_MISO) |     \
                                     PIN_OTYPE_PUSHPULL(NRF24L01_SPI_MOSI) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_I2C1SCL) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_I2C1SDA) |     \
                                     PIN_OTYPE_PUSHPULL(NRF24L01_SPI_CS) |     \
                                     PIN_OTYPE_PUSHPULL(NRF24L01_IRQ) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN10) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN11) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN12) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN13) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN14) |     \
                                     PIN_OTYPE_PUSHPULL(NRF24L01_CE))
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_VBAT) |        \
                                     PIN_OSPEED_HIGH(GPIOB_PIN1) |        \
                                     PIN_OSPEED_HIGH(GPIOB_PIN2) |        \
                                     PIN_OSPEED_HIGH(NRF24L01_SPI_SCK) |        \
                                     PIN_OSPEED_HIGH(NRF24L01_SPI_MISO) |        \
                                     PIN_OSPEED_HIGH(NRF24L01_SPI_MOSI) |        \
                                     PIN_OSPEED_HIGH(GPIOB_I2C1SCL) |        \
                                     PIN_OSPEED_HIGH(GPIOB_I2C1SDA) |        \
                                     PIN_OSPEED_HIGH(NRF24L01_SPI_CS) |        \
                                     PIN_OSPEED_HIGH(NRF24L01_IRQ) |        \
                                     PIN_OSPEED_HIGH(GPIOB_PIN10) |        \
                                     PIN_OSPEED_HIGH(GPIOB_PIN11) |        \
                                     PIN_OSPEED_HIGH(GPIOB_PIN12) |        \
                                     PIN_OSPEED_HIGH(GPIOB_PIN13) |        \
                                     PIN_OSPEED_HIGH(GPIOB_PIN14) |        \
                                     PIN_OSPEED_HIGH(NRF24L01_CE))
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_VBAT) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN1) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN2) |       \
                                     PIN_PUPDR_PULLUP(NRF24L01_SPI_SCK) |       \
                                     PIN_PUPDR_PULLUP(NRF24L01_SPI_MISO) |       \
                                     PIN_PUPDR_PULLUP(NRF24L01_SPI_MOSI) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_I2C1SCL) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_I2C1SDA) |       \
                                     PIN_PUPDR_PULLUP(NRF24L01_SPI_CS) |       \
                                     PIN_PUPDR_PULLUP(NRF24L01_IRQ) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN10) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN11) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN12) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN13) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN14) |       \
                                     PIN_PUPDR_PULLUP(NRF24L01_CE))
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_VBAT) |           \
                                     PIN_ODR_HIGH(GPIOB_PIN1) |           \
                                     PIN_ODR_HIGH(GPIOB_PIN2) |           \
                                     PIN_ODR_HIGH(NRF24L01_SPI_SCK) |           \
                                     PIN_ODR_HIGH(NRF24L01_SPI_MISO) |           \
                                     PIN_ODR_HIGH(NRF24L01_SPI_MOSI) |           \
                                     PIN_ODR_HIGH(GPIOB_I2C1SCL) |           \
                                     PIN_ODR_HIGH(GPIOB_I2C1SDA) |           \
                                     PIN_ODR_HIGH(NRF24L01_SPI_CS) |           \
                                     PIN_ODR_HIGH(NRF24L01_IRQ) |           \
                                     PIN_ODR_HIGH(GPIOB_PIN10) |           \
                                     PIN_ODR_HIGH(GPIOB_PIN11) |           \
                                     PIN_ODR_HIGH(GPIOB_PIN13) |           \
                                     PIN_ODR_HIGH(GPIOB_PIN14) |           \
                                     PIN_ODR_HIGH(NRF24L01_CE))
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_VBAT, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_PIN1, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_PIN2, 0U) |        \
                                     PIN_AFIO_AF(NRF24L01_SPI_SCK, 5U) |        \
                                     PIN_AFIO_AF(NRF24L01_SPI_MISO, 5U) |        \
                                     PIN_AFIO_AF(NRF24L01_SPI_MOSI, 5U) |        \
                                     PIN_AFIO_AF(GPIOB_I2C1SCL, 4U) |        \
                                     PIN_AFIO_AF(GPIOB_I2C1SDA, 4U))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(NRF24L01_SPI_CS, 0U) |        \
                                     PIN_AFIO_AF(NRF24L01_IRQ, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_PIN10, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_PIN11, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_PIN12, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_PIN13, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_PIN14, 0U) |        \
                                     PIN_AFIO_AF(NRF24L01_CE, 0U))
/*
 * GPIOC setup:
 *
